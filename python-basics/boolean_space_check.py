...
for char in text.lower():
    # Evaluate and print whether the current character is a space (returns True/False)
    # This acts as a debugging step before implementing conditional logic
    print(char == ' ')
    # Find the original index of the character
    index = alphabet.find(char)
    # Calculate the new shifted index
    new_index = index + shift
    # Append the newly shifted character to the encrypted_text string
